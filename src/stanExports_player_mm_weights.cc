...
#include "stanExports_player_mm_weights.h"

RCPP_MODULE(stan_fit4player_mm_weights_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_player_mm_weights")
